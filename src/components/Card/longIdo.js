...
const LongIdo = (props) => {
  ...
  if (!idoInfo) {
    return <s.Card ai="center" style={{ maxWidth: 500, margin: 20, minWidth: 400 }}></s.Card>;
  }
  ...
  return (
    ...
    >
      <s.Container>
        <s.Card fd="row" p={'20px'} ai="center" style={{ width: '100%' }} jc="space-between">
          <s.Container flex={3} fd={'row'} ai="center" style={{ flexWrap: 'nowrap' }}>
            <img
